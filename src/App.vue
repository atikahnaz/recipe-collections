...
<template>
  ...
  <HeroImage />
  <div class="px-6 pt-4 md:py-10 lg:px-14 xl:flex xl:flex-row-reverse">
    <div class="xl:w-1/3">
      <h1
        class="text-xl lg:text-2xl font-semibold py-3 md:pl-10 xl:text-center xl:pl-0"
      >
        My Recipe
      </h1>
      <div class="mt-2 mb-8">
    ...
    <div class="xl:w-2/3 md:pl-8 md:mr-4 lg:mr-8">
